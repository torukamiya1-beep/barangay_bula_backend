...
class Receipt {
  ...
  static async getClientReceipts(clientId, options = {}) {
    ...
    // Use CAST to ensure same collation for UNION
    const combinedQuery = `
      SELECT * FROM (
        SELECT 
          r.id,
          CAST(r.receipt_number AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as receipt_number,
          r.transaction_id,
          r.client_id,
          r.request_id,
          CAST(r.client_name AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_name,
          CAST(r.client_email AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_email,
          CAST(r.client_phone AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_phone,
          CAST(r.request_number AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as request_number,
          CAST(r.document_type AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as document_type,
          CAST(r.payment_method AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_method,
          CAST(r.payment_method_code AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_method_code,
          r.amount,
          r.processing_fee,
          r.net_amount,
          CAST(r.currency AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as currency,
          CAST(r.external_transaction_id AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as external_transaction_id,
          CAST(r.paymongo_payment_intent_id AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as paymongo_payment_intent_id,
          CAST(r.payment_status AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_status,
          r.receipt_date,
          r.payment_date,
          CAST(r.description AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as description,
          CAST(r.notes AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as notes,
          r.created_at,
          r.updated_at,
          'receipts' as source
        FROM receipts r
        ...
        SELECT 
          NULL as id,
          CAST(CONCAT('GCASH-', dr.request_number) AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as receipt_number,
          NULL as transaction_id,
          dr.client_id,
          dr.id as request_id,
          CAST(CONCAT(COALESCE(cp.first_name, ''), ' ', COALESCE(cp.last_name, '')) AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_name,
          CAST(COALESCE(cp.email, '') AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_email,
          CAST(COALESCE(cp.phone_number, '') AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as client_phone,
          CAST(dr.request_number AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as request_number,
          CAST(dt.type_name AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as document_type,
          CAST(COALESCE(pm.method_name, 'GCash Manual') AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_method,
          CAST(COALESCE(pm.method_code, 'gcash_manual') AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_method_code,
          dr.total_document_fee as amount,
          0 as processing_fee,
          dr.total_document_fee as net_amount,
          CAST('PHP' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as currency,
          CAST(dr.gcash_reference_number AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as external_transaction_id,
          CAST(NULL AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as paymongo_payment_intent_id,
          CAST(dr.payment_status AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as payment_status,
          ...
          CAST(CONCAT('GCash manual payment for ', COALESCE(dt.type_name, 'Document')) AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as description,
          CAST('Payment verified by admin' AS CHAR CHARACTER SET utf8mb4) COLLATE utf8mb4_unicode_ci as notes,
