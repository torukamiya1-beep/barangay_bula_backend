...
const supportingDocumentRoutes = require('./src/routes/supportingDocumentRoutes');
const beneficiaryVerificationRoutes = require('./src/routes/beneficiaryVerificationRoutes');
const authorizationDocumentRoutes = require('./src/routes/authorizationDocumentRoutes');
const authorizedPickupRoutes = require('./src/routes/authorizedPickupRoutes');
...
app.use('/api/supporting-documents', supportingDocumentRoutes);
app.use('/api/beneficiary-verification', beneficiaryVerificationRoutes);
